            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <div class="avatar avatar-lg bg-warning bg-opacity-10 rounded">
                                <i class="bx bxs-message-dots text-warning" style="font-size: 1.75rem;"></i>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ url('admin/jobs') }}" class="text-decoration-none">
                                <div class="p-3 text-center rounded border hover-shadow transition">
                                    <i class="bx bx-briefcase text-info mb-2" style="font-size: 2rem;"></i>
                                    <h6 class="small mb-0 text-dark">Job Sources</h6>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ url('admin/interviews/questions') }}" class="text-decoration-none">
                                <div class="p-3 text-center rounded border hover-shadow transition">
                                    <i class="bx bx-chat text-purple mb-2" style="font-size: 2rem;"></i>
